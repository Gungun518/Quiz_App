...
public class QuizFrame extends JFrame {
    ...
    boolean isReportSaved = reportDAO.addReport(report);

    // Save high score in the high_scores table
    HighScoreDAO highScoreDAO = new HighScoreDAO();
    boolean isHighScoreSaved = highScoreDAO.addHighScore(playerId, score, difficulty);

    if (!isReportSaved || !isHighScoreSaved) {
        JOptionPane.showMessageDialog(this, "Error saving score or high score!");
    }
}
}
