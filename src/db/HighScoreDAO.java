...
public class HighScoreDAO {
    ...
    public List<Player> getHighScoresByLevel(String level) {
        ...
        String query = "SELECT p.player_id, p.name AS player_name, hs.score " +
                       "FROM high_scores hs " +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                Player player = new Player(rs.getInt("player_id"), rs.getString("player_name"), rs.getInt("score"), level);
